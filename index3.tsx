...
export default function HomeScreen() {
  ...
  // ✅ Updated: fetch stats directly from backend
          ...
          <View style={styles.menuOverlay}>
            <TouchableWithoutFeedback>
              <View style={styles.menuContainer}>
                ...
                <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuNavigate('/explore')}>
                  <Ionicons name="compass" size={20} color="#3498db" style={styles.menuIcon} />
                  <Text style={styles.menuItemText}>Explore</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuNavigate('/admin')}>
                  <Ionicons name="settings" size={20} color="#3498db" style={styles.menuIcon} />
                  <Text style={styles.menuItemText}>Admin</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuNavigate('/report')}>
                  <Ionicons name="alert-circle" size={20} color="#3498db" style={styles.menuIcon} />
                  <Text style={styles.menuItemText}>Report Issues</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuNavigate('/login')}>
                  <Ionicons name="log-in" size={20} color="#3498db" style={styles.menuIcon} />
